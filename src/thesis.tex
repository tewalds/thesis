...
\def\program{Master of Science}  % Your degree
\def\school{University of Alberta}
\def\semester{Spring 2012}  % The convocation period when you submit your thesis:  Spring or Winter, then year
\def\dept{Department of Computing Science}  % Your department
