...
\addplot coordinates { (4,55.21) (5,56.82) (6,72.09) (7,55.30) (8,51.39) (9,49.59) (10,43.97) }; \addlegendentry{ 1}
\addplot coordinates { (4,56.59) (5,65.35) (6,72.28) (7,64.18) (8,60.95) (9,53.80) (10,40.56) }; \addlegendentry{ 2}
\addplot coordinates { (4,54.22) (5,57.00) (6,61.36) (7,60.56) (8,54.12) (9,55.45) (10,40.19) }; \addlegendentry{ 3}
\addplot coordinates { (4,45.88) (5,49.32) (6,65.31) (7,63.81) (8,59.86) (9,47.41) (10,48.15) }; \addlegendentry{ 4}
\addplot coordinates { (4,53.47) (5,59.31) (6,70.09) (7,49.14) (8,48.62) (9,51.68) (10,39.33) }; \addlegendentry{ 5}
\addplot coordinates { (4,49.45) (5,51.81) (6,51.85) (7,53.61) (8,45.74) (9,31.18) (10,13.83) }; \addlegendentry{10}
\end{axis}
\end{tikzpicture}
...
Figure \ref{tab:wintypedepth} shows the number of moves before each win condition is achieved, showing that rings occur the earliest, especially on big boards. This expected due to their smaller size and more local condition. If instead of ignoring all rings, we only allow rings for the first part of the rollout, and ignore all rings after that cutoff, we may allow legitimate ring threats, while ignoring rings that occur purely due to randomness. As the board size increases, this depth should also be increased, so instead of an absolute value, we'll use a fraction of the number of empty cells on the board.
