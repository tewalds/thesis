...
\begin{itemize}
	...
	\item Play the move to which your opponent has the weakest best reply
\end{itemize}
\begin{figure}
\centering
\begin{tikzpicture}[
...
\begin{itemize}
	\item Exponentially faster than Minimax, given good move ordering
	\item Used extensively in games with good heuristics, such as Chess, doesn't work without a heuristic
	\item Refinements:
	\begin{itemize}
...
\end{figure}
\begin{itemize}
\item Gives over an 80\% win rate (250 elo) on all board sizes.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Gives a 75-90\% win rate (200-300 elo) on all board sizes.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Gives a 55-65\% win rate (50-100 elo) on sizes 5 and up
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item As high as a 70\% win rate (150 elo), more important against humans.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Gives a 65\% win rate (100 elo) on all board sizes.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Not helpful except on size 4.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Gives a 55-65\% win rate (50-100 elo) on all board sizes.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Gives 60-70\% win rate (100 elo) on all board sizes.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item As high as a 60\% win rate (50 elo) on size 5, positive up to size 7.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item As high as a 70\% win rate (150 elo), positive up to size 9, probably better with ring rule.
\end{itemize}
\end{frame}
...
\end{axis}
\end{tikzpicture}
	\caption{Mate-in-one Checking Against Baseline RAVE Player}
	\label{fig:mateinone}
\end{figure}
\begin{itemize}
\item Barely positive on size 5, negative elsewhere.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Negative on all board sizes, may be better against humans.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Minor success on small boards, fails to defend against rings on big boards.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item As high as a 70\% win rate (150 elo) on medium boards, little success on big boards.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item As high as a 60\% win rate (50 elo) on medium boards, little effect on big boards.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Gives 60-65\% win rate (100 elo) on all boards, worth even more against humans.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Permanent ring matters the most, Multiple rollouts matters on smaller boards.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{itemize}
\item Distance is bad, quite a bit of redundancy here. In general, 80\% improvement on all boards.
\end{itemize}
\end{frame}
